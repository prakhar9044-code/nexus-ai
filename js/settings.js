...
const Settings = (() => {
    ...
    function listen() {
        ...
        document.getElementById('lang-select')?.addEventListener('change', e => { localStorage.setItem('nexus_lang', e.target.value); if (typeof I18n !== 'undefined') I18n.setLang(e.target.value); else Toast.show('Language updated', 'success'); });
